...
```{r echo = FALSE, message = FALSE, fig.cap=paste("Figure 1: Individuals Indicated for PrEP by Transmission Risk Group"), fig.width=6, fig.height=5}
transnums <- NULL
...
ggplot(data = transnums2, aes(x = Group, y = Individuals, fill = Group)) +
  ...
  scale_fill_manual("Transmission \n Risk Group", values = c("darkblue","red", "green")) +
  ...
  labs(caption = "Figure 1: Individuals Indicated for PrEP by Transmission Risk Group")
```
...
```{r echo=FALSE, fig.cap=paste("Figure 2: Individuals Indicated for PrEP by Race"), fig.width=6, fig.height=5}
msmnums <- NULL
...
ggplot(data = msmnums2, aes(x = Group, y = Individuals, fill = Group)) +
  ...
  geom_text(aes(label = Individuals), vjust = 1.6, color = "white", size = 7) +
  theme_minimal() + labs(title = "Individuals Indicated for PrEP \n by Race", 
  ...
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        axis.line = element_line(colour = "black")) +
  labs(caption = "Figure 2: MSM Indicated for PrEP by Race")
```
...
```{r echo=FALSE, fig.cap=paste("Figure 3: MSM Indicated for PrEP by Race"), fig.width=6, fig.height=5}
msmnums <- NULL
...
ggplot(data = msmnums2, aes(x = Group, y = Individuals, fill = Group)) +
  ...
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        axis.line = element_line(colour = "black")) +
  labs(caption = "Figure 3: MSM Indicated for PrEP by Race")
```
...
```{r echo=FALSE, fig.cap=paste("Figure 4: Heterosexuals Indicated for PrEP by Race"), fig.width=6, fig.height=5}
hetnums <- NULL
...
ggplot(data = hetnums2, aes(x = Group, y = Individuals, fill = Group)) +
  ...
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        axis.line = element_line(colour = "black")) +
  labs(caption = "Figure 4: HET Indicated for PrEP by Race")
```
...
```{r echo=FALSE, fig.cap=paste("Figure 5: Persons who Inject Drugs Indicated for PrEP by Race"), fig.width=6, fig.height=5}
pwidnums <- NULL
...
ggplot(data = pwidnums2, aes(x = Group, y = Individuals, fill = Group)) +
  ...
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        axis.line = element_line(colour = "black")) +
  labs(caption = "Figure 5: PWID Indicated for PrEP by Race")
```
...
perc <- c(round(100 * input$blackmsmprep / sums, 2), round(100 * input$blackhetprep / sums, 2), round(100 * input$blackpwidprep / sums, 2))
...
```{r echo=FALSE, fig.cap=paste("Figure 6: Black Individuals Indicated for PrEP by Transmission Risk Group"), fig.width=6, fig.height=5}
blacknums <- NULL
...
ggplot(data = blacknums2, aes(x = Group, y = Individuals, fill = Group)) +
  ...
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        axis.line = element_line(colour = "black")) +
  labs(caption = "Figure 6: Black Individuals Indicated for PrEP by Transmission Risk Group")
```
...
perc <- c(round(100 * input$hispmsmprep / sums, 2), round(100 * input$hisphetprep / sums, 2), round(100 * input$hisppwidprep / sums, 2))
...
```{r echo=FALSE, fig.cap=paste("Figure 7: Hispanic Individuals Indicated for PrEP by Transmission Risk Group"), fig.width=6, fig.height=5}
hispnums <- NULL
...
ggplot(data = hispnums2, aes(x = Group, y = Individuals, fill = Group)) +
  ...
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        axis.line = element_line(colour = "black")) +
  labs(caption = "Figure 7: Hispanic Individuals Indicated for PrEP by Transmission Risk Group")
```
...
perc <- c(round(100 * input$whitemsmprep / sums, 2), round(100 * input$whitehetprep / sums, 2), round(100 * input$whitepwidprep / sums, 2))
...
```{r echo=FALSE, fig.cap=paste("Figure 8: White Individuals Indicated for PrEP by Transmission Risk Group"), fig.width=6, fig.height=5}
whitenums <- NULL
...
ggplot(data = whitenums2, aes(x = Group, y = Individuals, fill = Group)) +
  ...
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        axis.line = element_line(colour = "black")) +
  labs(caption = "Figure 7: White Individuals Indicated for PrEP by Transmission Risk Group")
```
