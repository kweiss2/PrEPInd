...
df_footnote <- df
kable(df_footnote, "html", escape = FALSE, caption = "Table 1: Individuals with Indications for PrEP by Transmission Risk Group") %>%
kable_styling(bootstrap_options = c("striped", "hover", "bordered"), full_width = T, position = "left") %>%
...
df_footnote <- df
kable(df_footnote, "html", escape = FALSE, caption = "Table 2: Individuals with Indications for PrEP by Race") %>%
...
df_footnote <- df
kable(df_footnote, "html", escape = FALSE, caption = "Table 3: Individuals with Indications for PrEP by Race among MSM Transmission Risk Group") %>%
kable_styling(bootstrap_options = c("striped", "hover", "bordered"), full_width = T, position = "left") %>%
footnote(symbol = "Total may not sum to 100%",
           footnote_as_chunk = T)
```
...
df_footnote <- df
kable(df_footnote, "html", escape = FALSE, caption = "Table 4: Individuals with Indications for PrEP by Race among HET Transmission Risk Group") %>%
kable_styling(bootstrap_options = c("striped", "hover", "bordered"), full_width = T, position = "left") %>%
footnote(symbol = "Total may not sum to 100%",
           footnote_as_chunk = T)
```
...
df_footnote <- df
kable(df_footnote, "html", escape = FALSE, caption = "Table 5: Individuals with Indications for PrEP by Race among PWID Transmission Risk Group") %>%
kable_styling(bootstrap_options = c("striped", "hover", "bordered"), full_width = T, position = "left") %>%
footnote(symbol = "Total may not sum to 100%",
           footnote_as_chunk = T)
```
...
df_footnote <- df
kable(df_footnote, "html", escape = FALSE, caption = "Table 6: Individuals with Indications for PrEP by Transmission Risk Group among Black Individuals") %>%
kable_styling(bootstrap_options = c("striped", "hover", "bordered"), full_width = T, position = "left") %>%
footnote(symbol = "Total may not sum to 100%",
           footnote_as_chunk = T)
```
...
df_footnote <- df
kable(df_footnote, "html", escape = FALSE, caption = "Table 7: Individuals with Indications for PrEP by Transmission Risk Group among Hispanic Individuals") %>%
kable_styling(bootstrap_options = c("striped", "hover", "bordered"), full_width = T, position = "left") %>%
footnote(symbol = "Total may not sum to 100%",
           footnote_as_chunk = T)
```
...
df_footnote <- df
kable(df_footnote, "html", escape = FALSE, caption = "Table 8: Individuals with Indications for PrEP by Transmission Risk Group among White Individuals") %>%
kable_styling(bootstrap_options = c("striped", "hover", "bordered"), full_width = T, position = "left") %>%
footnote(symbol = "Total may not sum to 100%",
           footnote_as_chunk = T)
```
