                     ...
                     tabPanel("PrEP Indications",
                              ...
                              tabsetPanel(
                                tabPanel("Indications by Transmission Category",
                                         column(2,
                                                HTML("<h4 style=\"color:#2A268B\">1. Population Size and Jurisdiction</h4>"),
                                                ...
                                                br(),
                                                br(),
                                                HTML("<h4 style=\"color:#2A268B\">2. Assumptions about Diagnoses</h4>"),
                                         ...
                                         column(2,
                                                HTML("<h4 style=\"color:#2A268B\">3a. Race-specific diagnosis Information </h4>"),
                                         ...
                                         column(2,
                                                HTML("<h4 style=\"color:#2A268B\">3b. Race-specific diagnosis Information </h4>"),
                                         ...
                                         column(2,
                                                HTML("<h4 style=\"color:#2A268B\">4. PrEP Indications by Transmission Category</h4>"),
                                         ...
                                         column(3,
                                                HTML("<h4 style=\"color:#2A268B\">5.  PrEP Indications by Race and Transmission Category</h4>"),
